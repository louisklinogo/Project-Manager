...
1. **ES Modules Configuration:**
   ...
   - If you need CommonJS throughout your project, remove `"type": "module"` from package.json, but Project Manager scripts expect ESM.
...
Claude Project Manager is designed to work seamlessly with [Cursor AI](https://www.cursor.so/), providing a structured workflow for AI-driven development.
...
4. Configure with the following details:
   ...
   - Type: "Command"
   - Command: "npx -y project-manager-ai"
5. Save the settings
