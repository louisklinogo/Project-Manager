/**
 * tools/index.js
 * Export all Project Manager CLI tools for MCP server
 */
 ...
 */
export function registerProject-ManagerTools(server, asyncManager) {
  try {
    // Register each tool
    ...
    logger.error(`Error registering Project Manager tools: ${error.message}`);
    throw error;
  }
}

export default {
  registerProject-ManagerTools,
};
