...
import { initializeProjectDirect } from "../core/project-manager-core.js";

export function registerInitializeProjectTool(server) {
  server.addTool({
    name: "initialize_project",
    description:
      "Initializes a new Project Manager project structure by calling the core initialization logic. Creates necessary folders and configuration files for Project Manager in the current directory.",
    parameters: z.object({
      skipInstall: z
        .boolean()
        .optional()
      ...
      addAliases: z
        ...
        .optional()
        .default(false)
        .describe("Add shell aliases (tm, project-manager) to shell config file."),
      yes: z
        .boolean()
        .optional()
        .default(true)
