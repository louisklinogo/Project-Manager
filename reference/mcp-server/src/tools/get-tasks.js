/**
 * tools/get-tasks.js
 * Tool to get all tasks from Project Manager
 */
...
import { listTasksDirect } from "../core/project-manager-core.js";
...
export function registerListTasksTool(server) {
  server.addTool({
    name: "get_tasks",
    description:
      "Get all tasks from Project Manager, optionally filtering by status and including subtasks.",
    parameters: z.object({
      status: z
        .string()
        .optional()
