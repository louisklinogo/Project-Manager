/**
 * path-utils.js
 * Utility functions for file path operations in Project Manager
 *
 * This module provides robust path resolution for both:
 * 1. PACKAGE PATH: Where project-manager code is installed
 *    (global node_modules OR local ./node_modules/project-manager OR direct from repo)
...
/**
 * Gets the path to the project-manager package installation directory
...
export function getPackagePath() {
  ...
  // In dev: /path/to/project-manager/mcp-server/src/core/utils -> /path/to/project-manager
  // In npm: /path/to/node_modules/project-manager/mcp-server/src/core/utils -> /path/to/node_modules/project-manager
    ...
    try {
      ...
      try {
        ...
        return findTasksJsonInDirectory(
          path.join(homeDir, ".project-manager"),
          null,
          log,
        );
      } catch (thirdError) {
