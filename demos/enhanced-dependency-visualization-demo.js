...
function generateAndSaveVisualizations(tasks) {
  ...
  fs.writeFileSync(path.join(outputDir, 'dependency-mermaid.md'), mermaidOutput);
  console.log(`Saved Mermaid visualization to ${path.join(outputDir, 'dependency-mermaid.md')}`);
  ...
  fs.writeFileSync(path.join(outputDir, 'dependency-interactive.html'), interactiveOutput);
  console.log(`Saved interactive visualization to ${path.join(outputDir, 'dependency-interactive.html')}`);
  ...
  fs.writeFileSync(path.join(outputDir, 'dependency-collapsible.html'), collapsibleOutput);
  console.log(`Saved collapsible visualization to ${path.join(outputDir, 'dependency-collapsible.html')}`);
}
...
async function runDemo() {
  ...
  try {
    ...
    console.log('Check the demos/output directory for the generated visualizations.');
  } catch (error) {
