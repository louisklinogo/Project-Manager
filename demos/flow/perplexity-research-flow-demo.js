  ...
  async exec(data) {
    ...
    if (this.useMockData) {
      ...
      return {
        ...
        citations: [
          "https://example.com/mock-citation-1",
          "https://example.com/mock-citation-2",
        ],
      };
    }
    ...
    try {
      ...
      const messages = [
        ...
        {
          role: "user",
          content: `Research the following topic thoroughly: ${data.formattedQuery}`,
        },
      ];
      ...
      return {
        ...
        content:
          "API Error occurred. This is fallback mock data for the query: " +
          data.query,
