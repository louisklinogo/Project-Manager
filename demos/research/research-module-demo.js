...
import { ResearchModule } from "../project-manager/src/modules/research-module.js";
import { KnowledgeBase } from "../project-manager/src/models/knowledge-base.js";
import { PerplexityProvider } from "../project-manager/src/providers/perplexity-provider.js";
...
function addToKnowledgeBase(results, category) {
  console.log(
    `Adding research results to knowledge base under category: ${category}...\n`,
  );
